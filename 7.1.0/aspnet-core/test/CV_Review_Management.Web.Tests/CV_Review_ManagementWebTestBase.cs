...
{
    public abstract class CV_Review_ManagementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CV_Review_ManagementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CV_Review_ManagementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CV_Review_ManagementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CV_Review_ManagementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CV_Review_ManagementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CV_Review_ManagementDbContext, Task<T>> func)
        {
            T result;
