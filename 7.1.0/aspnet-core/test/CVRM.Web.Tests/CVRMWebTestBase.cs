...
{
    public abstract class CVRMWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CVRMWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CVRMWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CVRMDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CVRMDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CVRMDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CVRMDbContext, Task<T>> func)
        {
            T result;
