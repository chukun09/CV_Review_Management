...
namespace CVRM.Migrations
{
    ...
    [Migration("20220725005330_Add_New_Column_ImagePath_For_CV_Entity")]
    partial class Add_New_Column_ImagePath_For_CV_Entity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CVRM.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CVRM.Entites.AddressEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CVRM.Entites.CertificateEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("cv_certificate");
                });

            modelBuilder.Entity("CVRM.Entites.CommentEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CVRM.Entites.EducationEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CVRM.Entites.ExperienceEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("cv_experience");
                });

            modelBuilder.Entity("CVRM.Entites.HobbyEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CVRM.Entites.Province", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CVRM.Entites.UserEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CVRM.Entites.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CVRM.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("CVRM.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("CVRM.Entites.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("CVRM.Authorization.Roles.Role", b =>
                {
                    b.HasOne("CVRM.Entites.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("CVRM.Entites.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("CVRM.Entites.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("CVRM.Entites.AddressEntity", b =>
                {
                    b.HasOne("CVRM.Entites.District", "District")
                        .WithMany()
                        .HasForeignKey("DistrictId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CVRM.Entites.Province", "Province")
                        .WithMany()
            ...
            modelBuilder.Entity("CVRM.Entites.CommentEntity", b =>
                {
                    ...
                    b.HasOne("CVRM.Entites.CommentEntity", "CommentParent")
                        .WithMany()
                        .HasForeignKey("CommentId");

                    b.HasOne("CVRM.Entites.UserEntity", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CVRM.Entites.UserEntity", b =>
                {
                    b.HasOne("CVRM.Entites.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
